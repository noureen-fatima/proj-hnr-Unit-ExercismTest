...
public class BirdWatcherTest {
    ...
    @Test
    public void allCountArePositive() {
        lastWeek = birdWatcher.getLastWeek();
        Assert.assertTrue("Day 1 should be positive",lastWeek[0] > -1);
        Assert.assertTrue("Day 2 should be positive",lastWeek[1] > -1);
        Assert.assertTrue("Day 3 should be positive",lastWeek[2] > -1);
        Assert.assertTrue("Day 4 should be positive",lastWeek[3] > -1);
        Assert.assertTrue("Day 5 should be positive",lastWeek[4] > -1);
        Assert.assertTrue("Day 6 should be positive",lastWeek[5] > -1);
        Assert.assertTrue("TODAY should be positive",lastWeek[6] > -1);
    }
}
